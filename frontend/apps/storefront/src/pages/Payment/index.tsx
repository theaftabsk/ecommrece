...
const IconSignal = () => (<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1.75 8.75a11 11 0 0 1 20.5 0"/><path d="M5 12.5a7 7 0 0 1 14 0"/><path d="M8.5 16a3.5 3.5 0 0 1 7 0"/><circle cx="12" cy="20" r="1" fill="currentColor"/></svg>);
...
const IconCheckDone = () => (<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>);

const VERIFY_STEPS = [
  { icon: <IconLock />, label: 'Securing client-server communication...' },
  { icon: <IconSignal />, label: 'Fetching Razorpay transaction signature...' },
  { icon: <IconShield />, label: 'Verifying payload cryptographically on server...' },
  { icon: <IconBox />, label: 'Updating merchant inventory logs...' },
  { icon: <IconCheck />, label: 'Confirming your order...' },
];
            ...
            <>
              ...
              <div className="verify-steps">
                {VERIFY_STEPS.map((step, i) => (
                  ...
                  >
                    <span className="step-icon">{i < verifyStep ? <IconCheckDone /> : step.icon}</span>
